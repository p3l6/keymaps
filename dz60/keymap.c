...
#define LT_SYMBL LT(_SYMBL, KC_ENT)
...
[_BASE] = LAYOUT_60_ansi_split_bs_rshift(
    ...
    LT_SYMBL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
    KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSPC, LT_MEDIA,
    XXXXXXX, KC_LALT, KC_LGUI,                          LT(_NAV, KC_SPC),                    XXXXXXX, KC_RGUI, KC_RCTL, XXXXXXX
